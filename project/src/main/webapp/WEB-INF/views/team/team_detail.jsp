                ...
                <div class="col-md-9 col-sm-9 blog-item">
                    ...
                    <div class="front-carousel">
                      <div id="myCarousel" class="carousel slide">
                        ...
                        <div class="carousel-inner">
                          <div class="item">
                            <img src="${pageContext.request.contextPath}/assets/pages/img/posts/img1.jpg" alt="">
                          </div>
                          <div class="item">
                            <!-- BEGIN VIDEO -->   
                          ...
                          <div class="item active">
                            <img src="${pageContext.request.contextPath}/assets/pages/img/posts/img3.jpg" alt="">
                          </div>
                        </div>
                        <!-- Carousel nav -->
                  ...
                  <div class="comments">
                    <div class="media">                    
                      ...
                      <img src="${pageContext.request.contextPath}/assets/pages/img/people/img1-small.jpg" alt="" class="media-object">
                      </a>
                      <div class="media-body">
                        ...
                        <div class="media">
                          <a href="javascript:;" class="pull-left">
                          <img src="${pageContext.request.contextPath}/assets/pages/img/people/img2-small.jpg" alt="" class="media-object">
                          </a>
                          <div class="media-body">
                        ...
                        <div class="media">
                          <a href="javascript:;" class="pull-left">
                          <img src="${pageContext.request.contextPath}/assets/pages/img/people/img3-small.jpg" alt="" class="media-object">
                          </a>
                          <div class="media-body">
                    ...
                    <div class="media">
                      <a href="javascript:;" class="pull-left">
                      <img src="${pageContext.request.contextPath}/assets/pages/img/people/img4-small.jpg" alt="" class="media-object">
                      </a>
                      <div class="media-body">
